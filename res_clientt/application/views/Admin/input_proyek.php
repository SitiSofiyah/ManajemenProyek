...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <form action="<?php echo base_url('index.php/proyek/create'); ?>" class="form-horizontal form-material" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Jenis Proyek</label>
                                    <div class="col-md-12">
                                        <input type="text" name="jenis_proyek" class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Waktu Pengerjaan</label>
                                    <div class="col-md-12">
                                        <input type="text"  class="form-control form-control-line" name="waktu_pengerjaan" id="example-email"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Jumlah Tukang</label>
                                    <div class="col-md-12">
                                        <input type="text" name="jumlah_tukang" class="form-control form-control-line"> 
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        $.toast({
            ...
            text: 'Inputkan data proyek yang disediakan',
            position: 'top-right',
            loaderBg: '#ff6849',
            icon: 'info',
            hideAfter: 3500,
