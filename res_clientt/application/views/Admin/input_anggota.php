            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                         <?php 
                                   $jmlSkrg = $jml2[0]->jml;
                                   $jmlHarus = $jml1[0]->jumlah_tukang;
                                   if($jmlSkrg < $jmlHarus){

                                    $jmlT = $jmlHarus-$jmlSkrg;
                                    echo "Kurang $jmlT Tukang lagi !!!";
                         ?>
                        <div class="white-box">
                            <form action="<?php echo base_url('index.php/grup/add'); ?>" class="form-horizontal form-material" method="post">

                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Nama Tukang</label>
                                    <div class="col-md-12">
                                        <input type="hidden" name="id_grup" value="<?php echo $this->uri->segment(3) ?>">
                                   
                                       <select name="id_tukang" class="form-control form-control-line">
                                        <?php foreach ($tukang as $key) { ?>
                                           <option value="<?php echo $key->id_tukang  ?>">
                                               <?php  echo $key->nama_tukang  ?>
                                           </option>
                                        <?php } ?>
                                       </select>                              
