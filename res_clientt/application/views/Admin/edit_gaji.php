        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                 <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url ('index.php/gaji')?>" class="waves-effect active"><i class="fa fa-columns fa-fw" aria-hidden="true"></i><span class="hide-menu">Penggajian</span></a>
                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <form action="<?php echo base_url('index.php/gaji/edit'); ?>" class="form-horizontal form-material" method="post">
                               
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Gaji</label>
                                    <div class="col-md-12">
                                        <input value="<?php echo $gaji[0]->gaji ?>" type="text"  class="form-control form-control-line" name="gaji" id="example-email"> 
                                    </div>
                                </div>
