                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="white-box">
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <a href="<?php echo base_url('index.php/gaji/edit/' .$row->id_gaji) ?>" class="btn btn-info">Edit</a>
                                        </td>
                          ...
                          <div class="white-box">
                            <h3 class="box-title">Gaji Tukang
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo "Rp.".number_format($row->gaji,2,',','.') ?></td> 
