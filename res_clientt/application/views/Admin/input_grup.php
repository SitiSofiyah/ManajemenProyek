            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <form action="<?php echo base_url('index.php/grup/create'); ?>" class="form-horizontal form-material" method="post">
                               
                              
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Jenis Proyek</label>
                                    <div class="col-md-12">
                                       <select name="proyek" class="form-control form-control-line">
                                        <?php foreach ($proyek as $key) { ?>
                                           <option value="<?php echo $key->id_proyek  ?>">
                                               <?php  echo $key->jenis_proyek  ?>
                                           </option>
                                        <?php } ?>
                                       </select>
                                    </div>
