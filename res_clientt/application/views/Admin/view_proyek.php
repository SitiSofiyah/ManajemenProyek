            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <a href="<?php echo base_url('index.php/proyek/create')  ?>">
                        ...
                        <div class="white-box">
                            <h3 class="box-title">Recent Proyek
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <a href="<?php echo base_url('index.php/proyek/edit/' .$row->id_proyek) ?>" class="btn btn-info">Edit</a>
                                            <a href="<?php echo base_url('index.php/proyek/delete/' .$row->id_proyek) ?>" class="btn btn-danger">Delete</a>
                                        </td>
