    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                 <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url ('index.php/manajemen')?>" class="waves-effect active"><i class="fa fa-globe fa-fw" aria-hidden="true"></i><span class="hide-menu">Manajemen Proyek</span></a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                    <a href="<?php echo base_url('index.php/gaji/create')  ?>">
                        <Button class="btn btn-success"><i class="fa fa-plus"></i> Tambah</Button>
                    </a>
                        <div class="white-box">
                            <h3 class="box-title">Recent Gaji
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $row->jumlah_tukang ?> orang</td>
                                          <td><?php echo $row->waktu_pengerjaan ?> Hari</td>
                                          <td><?php echo $row->pesan ?></td>
                                          <td><?php echo $row->status ?></td>

                                          <td>
                                            <?php if($row->status == "order") { ?>
                                            <a href="<?php echo base_url('index.php/manajemen/terima/' .$row->id_order) ?>" class="btn btn-info">Terima Order</a>
                                        <?php } ?>
                                        <?php if($row->status == "terima") { ?>
                                            <a href="<?php echo base_url('index.php/manajemen/detail/' .$row->id_order) ?>" class="btn btn-info">Detail</a>
                                        <?php } ?>
                                            <a href="<?php echo base_url('index.php/manajemen/delete/' .$row->id_order) ?>" class="btn btn-danger">Tolak</a> 
                                        </td>
