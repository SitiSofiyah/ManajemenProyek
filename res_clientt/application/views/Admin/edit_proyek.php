        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                 <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url ('index.php/proyek')?>" class="waves-effect active"><i class="fa fa-font fa-fw" aria-hidden="true"></i><span class="hide-menu">Proyek</span></a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <form action="<?php echo base_url('index.php/proyek/edit'); ?>" class="form-horizontal form-material" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Jenis Proyek</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<?php echo $proyek[0]->jenis_proyek ?>" name="jenis_proyek" class="form-control form-control-line">
                                        <input type="hidden" value="<?php echo $proyek[0]->id_proyek ?>" name="id_proyek" class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Waktu Pengerjaan</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<?php echo $proyek[0]->jumlah_tukang ?>"  class="form-control form-control-line" name="waktu_pengerjaan" id="example-email"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Jumlah Tukang</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<?php echo $proyek[0]->waktu_pengerjaan ?>" name="jumlah_tukang" class="form-control form-control-line"> 
                                    </div>
                                </div>
