            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">View Group</h4> </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                    <a href="<?php echo base_url('index.php/grup/create')  ?>">
                        <Button class="btn btn-success"><i class="fa fa-plus"></i> Tambah</Button>
                    </a>
                        <div class="white-box">
                            <h3 class="box-title">Recent Group
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <a href="<?php echo base_url('index.php/grup/add/' .$row->id_grup) ?>" class="btn btn-info">Anggota</a>
                                            <a href="<?php echo base_url('index.php/proyek/delete/' .$row->id_grup) ?>" class="btn btn-danger">Delete</a>
                                        </td>
