            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <form action="<?php echo base_url('index.php/tukang/edit'); ?>" class="form-horizontal form-material" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Nama Tukang</label>
                                    <div class="col-md-12">
                                        <input value="<?php echo $tukang[0]->nama_tukang ?>" type="text" name="nama_tukang" class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Alamat</label>
                                    <div class="col-md-12">
                                        <input value="<?php echo $tukang[0]->alamat ?>" type="text"  class="form-control form-control-line" name="alamat" id="example-email"> 
                                        <input value="<?php echo $tukang[0]->id_tukang ?>" type="hidden"  class="form-control form-control-line" name="id_tukang" id="example-email"> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input value="<?php echo $tukang[0]->no_telp ?>" type="text" name="no_telp" class="form-control form-control-line"> 
                                    </div>
                                </div>
